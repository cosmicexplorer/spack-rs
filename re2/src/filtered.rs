...
/// let s = ExpressionIndex::from_index(0);
/// let a = ExpressionIndex::from_index(1);
/// let asay = ExpressionIndex::from_index(2);
/// let asdf = ExpressionIndex::from_index(3);
///
/// let mut atoms = MatchedSetInfo::empty();
/// atoms.set_len(4);
/// let ats = atoms.as_mut_slice();
/// ats[0] = s;
/// ats[1] = a;
/// ats[2] = asay;
/// ats[3] = asdf;
...
/// assert_eq!(matches.as_slice(), &[x, y, z]);
///
/// // Remove the "asdf" atom:
/// atoms.set_len(3);
